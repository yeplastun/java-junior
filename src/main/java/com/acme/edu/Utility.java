...
//    private static final Map<Class, LoggerCommand> COMMANDS;
//
//    static {
...
////    }
//
//    static <V> V getCommandFromMapOrDefault(Class clazz, Map<Class, V> map) {
...
//        System.out.println(getObjectFromMapOrDefault(state.getPreviousClass(), FORMATTERS).apply(state.getPreviousInstance()));
//    }
